const siteContent = {
  ...
  heroMetrics: [
    ...
    { value: "0.4s", label: "First Paint" },
    { value: "24/7", label: "Pages-ready" },
  ],
  projects: [
    {
      title: "Launch Pages",
    ...
    },
    {
      ...
      summary: "Modulare UI-Bausteine, die wiederholbar bleiben und trotzdem hochwertig wirken.",
      tags: ["Components", "Motion", "CSS"],
      tone: "dark",
    },
    {
      title: "Product Motion",
      kicker: "Scroll Experiences",
      summary: "Scroll-Reveals, Parallax-Schichten und fokussierte Animationen ohne unnötige Schwere.",
  ...
  services: [
    {
      icon: "sparkles",
      title: "Apple-like Look",
      text: "Große Produktmomente, ruhige Typografie, schwebende Oberflächen und flüssige Übergänge.",
    },
    {
      icon: "layers-3",
      title: "Template-System",
      text: "Inhalte leben zentral in JavaScript-Objekten und werden automatisch als Sektionen gerendert.",
    },
    {
      icon: "gauge",
      title: "Schnelle Pages",
      text: "Keine Build-Pflicht: Die Website läuft direkt statisch auf GitHub Pages.",
    },
  ],
  stack: ["HTML5", "CSS3", "JavaScript", "Tailwind CSS", "DaisyUI", "Lucide Icons", "GitHub Pages"],
  timeline: [
    { year: "01", title: "Define", text: "Positionierung, Seitenstruktur und Komponentenraster festlegen." },
    { year: "02", title: "Craft", text: "Oberflächen, Motion und responsive Details ausarbeiten." },
    { year: "03", title: "Ship", text: "Statisch deployen, messen und Inhalte iterativ erweitern." },
  ],
};
    ...
    <div class="mx-auto grid min-h-[calc(92svh-3.5rem)] max-w-7xl content-center gap-12 px-5 py-20 md:grid-cols-[0.92fr_1.08fr] md:px-8">
      <div class="max-w-3xl self-center">
        ...
        <p class="reveal mt-7 max-w-2xl text-pretty text-lg leading-8 text-neutral-600 md:text-xl">
          Eine schnelle, elegante GitHub-Pages-Website mit Tailwind CSS, DaisyUI, flüssigen Scroll-Effekten und modularen Inhalten.
        </p>
  ...
  <section id="work" class="section-pad bg-neutral-950 text-white">
    <div class="mx-auto max-w-7xl px-5 md:px-8">
      <div class="section-heading reveal">
        <p class="eyebrow text-white/55">Work</p>
  ...
  <section id="studio" class="section-pad overflow-hidden bg-base-100">
    <div class="mx-auto grid max-w-7xl gap-12 px-5 md:grid-cols-[0.85fr_1.15fr] md:px-8">
      <div class="reveal">
        ...
        <p class="mt-6 text-lg leading-8 text-neutral-600">Die Seite ist als kleine Komponentenmaschine gebaut: Daten rein, Sektionen raus, Animationen automatisch aktiv.</p>
      </div>
...
const ContactComponent = `
  <section id="contact" class="section-pad bg-neutral-950 text-white">
    <div class="mx-auto max-w-5xl px-5 text-center md:px-8">
      ...
      <p class="reveal mx-auto mt-7 max-w-2xl text-lg leading-8 text-white/65">Bereit für Portfolio, Produktseite, Tooling-Doku oder eine persönliche Developer-Brand, die nicht nach Standard-Template aussieht.</p>
      <div class="reveal mt-10 flex flex-wrap justify-center gap-3">
        <a href="mailto:hello@intensed.dev" class="btn rounded-full border-0 bg-white px-7 text-neutral-950 hover:bg-white/90">
          ${icon("mail", "h-4 w-4")}
          hello@intensed.dev
        </a>
